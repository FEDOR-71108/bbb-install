...
Install BigBlueButton 2.6.x with a SSL certificate from Let's Encrypt using hostname bbb.fpm.com
and email address plotnikovfm2008@gmail.com and apply a basic firewall
